Во втором кейсе вам предстоит работать с более привычным типом данных. Это уже знакомый вам `csv` - файл с еще более привычными аналитику данными о запущенных рекламных кампаниях.
