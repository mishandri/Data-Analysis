...
Создан полностью автоматизированный пайплайн для сбора чеков в одну таблицу БД.
...
![Подключение к БД](img/2025-05-12_20-49-23.png)

### Выгрузка в БД

Выгружаются файлы `.csv` из директории `data/`. Другие форматы файлов игнорируются.
![Подключение к БД](img/2025-05-11_14-55-45.png)
